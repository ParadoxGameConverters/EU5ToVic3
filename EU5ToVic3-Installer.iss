...
#define MyAppName "EU5 to Vic3"
#define MyAppVersion "0.0 Aardwark"
...
AppId={{731C33F9-1C45-4C38-AE13-A798CAD5757E}
AppName={#MyAppName}
...
DefaultDirName={autopf}\EU5ToVic3
DisableProgramGroupPage=yes
; Uncomment the following line to run in non administrative install mode (install for current user only.)
PrivilegesRequired=lowest
PrivilegesRequiredOverridesAllowed=commandline
OutputBaseFilename=EU5ToVic3-latest-win-x64
Compression=lzma
...
[InstallDelete]
Type: filesandordirs; Name: "{app}\EU5ToVic3\blankMod"
Type: filesandordirs; Name: "{app}\EU5ToVic3\configurables"
